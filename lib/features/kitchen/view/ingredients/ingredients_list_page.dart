...
class IngredientListingPage extends StatefulWidget {
  final IngredientPresenter presenter;
  const IngredientListingPage({super.key, required this.presenter});
...
class _IngredientListingPageState extends State<IngredientListingPage> {
  ...
  void initState() {
    super.initState();
    widget.presenter.onLoadIngredients();
  }
    ...
    return Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) =>
            IngredientTileUI(kitchenPresenter: widget.presenter),
      ),
    );
  }
}
